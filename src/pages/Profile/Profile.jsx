  ...
  return (
    <div>
     <div className="flex flex-col md:flex-row h-full min-h-screen w-screen bg-gray-900 text-gray-100">
        ...
        <Sidebar />
        <div className="min-h-screen bg-white text-purple-900 py-12 px-4 sm:px-6 lg:px-8 w-full">
      <div className="w-full mx-auto bg-white rounded-lg shadow-xl overflow-hidden border border-purple-200">
